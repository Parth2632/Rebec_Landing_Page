...
const MainButton = forwardRef<HTMLButtonElement, MainButtonProps>(
  (
    ...
    const getVariantStyles = () => {
        return {
        base: "!bg-[#B9FF66] !text-black border-[#B9FF66] rounded-xl shadow-sm",
        hover: "hover:!bg-[#18181B] hover:!text-white hover:border-[#18181B] hover:shadow-md rounded-xl"
        };
    };
    ...
    return !isLoading ? (
      <Button
        form={form}
        className={`border ${variantStyles.base} ${propWidth} md:${propWidth} select-none rounded-[14px] transition-colors duration-200 ${variantStyles.hover} ${size_height} ${classes}`}
